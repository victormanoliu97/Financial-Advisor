...
public class CustomerProfilingServiceImpl implements CustomerProfilingService  {
    ...
    @Override
    public CustomerProfilingDTO getCustomerProfiling(Integer customerId) {
        if(customerId == null) {
            return null;
        }
        ...
        return new CustomerProfilingMapper().fromEntityListToDTOList(customerProfilingRepository.getAllByIdCustomer(customerId)).get(0);
    }
